...
<task type="auto">
  ...
  <action>
**First:** Discover the GitHub username by running `gh api user --jq '.login'` or parsing `git remote get-url origin`. Store this — you'll need it for the clone URL in the README.
